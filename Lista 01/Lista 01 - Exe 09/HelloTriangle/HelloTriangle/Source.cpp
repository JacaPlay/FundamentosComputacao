...
int main()
{
	...
	// Cabeça (Cinza Claro): (0.6f, 0.6f, 0.6f, 1.0f)
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.6f, 0.6f, 0.6f, 1.0f); // Enviando cor para variável uniform inputColor (Muda a cor do triângulo)
		...
		glUniform4f(colorLoc, 0.3f, 0.3f, 0.3f, 1.0f); // Enviando cor para variável uniform inputColor (Muda a cor do triângulo)
		...
		glUniform4f(colorLoc, 1.0f, 0.0f, 0.0f, 1.0f); // Enviando cor para variável uniform inputColor (Muda a cor do triângulo)
		...
		glUniform4f(colorLoc, 1.0f, 1.0f, 0.0f, 1.0f); // Enviando cor para variável uniform inputColor (Muda a cor do triângulo)
