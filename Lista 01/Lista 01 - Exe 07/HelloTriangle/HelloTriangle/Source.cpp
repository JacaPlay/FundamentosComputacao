...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Eae Espiral! - Jairo", nullptr, nullptr);
	...
	int nPoints3;
	GLuint VAO2 = createEspiral(3, nPoints3); // Se aumentar o "3", a espiral fica com mais voltas.

	// Apaga o inputColor que tava aqui
	glUseProgram(shader.ID);


	// Coisas do GLM, criando a matriz
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Faz o triângulo mudar de acordo com o tamanho da tela
...
int createEspiral(int turns, int& nPoints)
{
	...
	// Não precisa da parte que fica aqui, porque não vai ser desenhado preenchido.

	// Gerando as coordenadas dos pontos do círculo
	while (angle <= 2 * Pi * turns) // Em vez de ser uma volta só, como nos exe anteriores, aqui é 360 vezes o número de voltas pedidos.
	{
		...
		angle += slice;
		radius += 0.005; // Com "0.01" ele enche toda a tela. Isso aumenta o tamanho do raio a cada interação.

	}

	nPoints = vertices.size() / 6; // É pra pegar o número total de vértices. 2 atributos com 6 floats.
