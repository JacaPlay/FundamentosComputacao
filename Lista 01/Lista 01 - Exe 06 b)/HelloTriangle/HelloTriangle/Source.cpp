...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Eae Pentagono! - Jairo", nullptr, nullptr);
	...
	int nPoints = 6;
	//int nPoints = 20; => Faz um círculo.
	//int nPoints = 200; => Deixa o círculo mais redondinho.
	//int nPoints = 9; => Faz um Octágono.
	//int nPoints = 6; => Faz um Pentágono.
	// Pro Pac-man é preciso variar o ângulo, não começar do zero e nem ir até o 360.
	// Pizza é mesmo que o Pac-man com um intervalo menor.
	// Estrela é com um raio que não é fixo. Um raio que aumenta ou diminuí, com par ímpar por exemplo.
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLE_FAN, 0, nPoints + 1); // Ponto Central
